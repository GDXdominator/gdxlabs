...
descs.set(
    "Tree Demon", [
        "I think The Treemon would've been a better name. As the name suggests, this demon looks like a tree and knows it. Standing at approximately 10 feet tall, 3 feet above Lucy, with lanky, branch-like arms, and high speeds, this thing is able to quickly hide and blend into the forest foliage undetected. The Treemon is quite weak, with its tall, skinny, and frail body, so it relies on its role being to assist other creatures of the forest. It does so through its enchanting whistle that echoes throughout the forest so creatures hear it and know where to look for food (you), where it can then eat the scraps.",
...
descs.set(
    "Billy", [
        "My goat. A little cranky, but always down to clown. Billy's existence I believe to be a cruel irony as a black metal fiend who's <em>gay</em> and scared of satanists because he thinks they'll sacrifice him... My friend Julie has also written an " + link("/Bios/candlegoat.html", "excellent description") + " of this fellow.",
        "Should you come across this strange creature, do not display certain symbols on your garments " + poserString + ", or else it will be really annoying for 5 minutes.",
...
descs.set(
    "Benny", [
        ...
        "Say hi! This guy wouldn't hurt a fly...",
...
descs.set(
    "Boris", [
        "Chill, death metal guy who runs the forest's \"Super Awesome Metal Club\" alongisde Melvin. Both are two peas in a pod.",
        "nothing",
